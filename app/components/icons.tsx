// Inline SVG icon components — no external icon library needed.
// All icons accept optional `size` (default 16) and `className` props.
...
export function MediSyncLogo({ size = 28, className = '' }: IconProps) {
  return (
...
export function WaitlistIcon({ size = 16, className = '' }: IconProps) {
  return (
