    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-lg font-bold text-slate-800">MediSync Admin</span>
        </div>
        <button
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className="w-52 min-h-screen bg-white border-r border-slate-200 p-4">
            ...
            {([
              ...
              <button
                ...
                className={`w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-colors text-left ${
                  tab === t ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:bg-slate-50'
                }`}
              >
